...
Risk bands run from 1 (lowest risk) to 5 (highest). probability_of_default is the chance the loan is not repaid in full over its term, from 0 to 1. suggested_min_voucher_cover is the share of principal (0 to 1) you would want vouchers to stake. Keep key_risks short and concrete, and write the rationale for a lender who will read it before funding.`;
